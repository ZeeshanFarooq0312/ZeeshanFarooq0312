...
<div align="center">
  <img src="https://github-readme-stats.shion.dev/api?username=ZeeshanFarooq0312&show_icons=true&theme=tokyonight&hide_border=true&count_private=true" alt="Zeeshan's GitHub Stats" height="175" />
  <img src="https://github-readme-stats.shion.dev/api/top-langs/?username=ZeeshanFarooq0312&layout=compact&theme=tokyonight&hide_border=true" alt="Top Languages" height="175" />
</div>
...
🔭 Currently working at **IOPTIME** — building intelligent automation, computer vision pipelines, and LLM integrations  
👯 Looking to collaborate on **ML / AI research projects** and **open-source AI tools**  
🤝 Looking for help with **advanced deep learning optimizations**  
🌱 Currently learning **multi-modal AI**, **LLM fine-tuning**, and **Vision-Language Models (VLMs)**  
💬 Ask me about **AI, Computer Vision, RAG systems, LLM deployment, or Voice Agents**  
⚡ Fun fact: I love building real-world AI systems — from cement mill monitoring to AI physicians!
...
| Project | Description |
|---|---|
| 🔍 **AuditX – Audit Assistant** | Optimized local LLM (GPT-OSS20B, quantized) for low-latency, memory-efficient auditing |
| 🃏 **AI Poker Card App (Ozzo)** | Fine-tuned YOLO model tracking poker card movements in real time |
| 🩺 **AI Physician – Voice Agent** | Voice assistant diagnosing symptoms & recommending prescriptions via LLMs |
| ♻️ **Smart Trash Recycling App** | Flutter app + YOLOv8 to detect & classify recyclable materials |
| 🦙 **Local LLM Deployment** | Deployed Ollama & vLLM with Docker; integrated VLMs for multimodal tasks |
| 📰 **News Bot – RAG System** | FAISS + LangChain Q&A system with blog-based document retrieval |
| 📅 **AI Appointment Booker** | Autonomous agent for scheduling via voice/chat + calendar API integration |
| 🎥 **AI Camera Tracing System** | Multi-view YOLO + Re-ID tracking for trucks & persons with automated logs |
| 📞 **AI Call Routing Agent** | Voice-driven NLP routing system reducing support response time |
...
![LoRA](https://img.shields.io/badge/LoRA%20%2F%20QLoRA-00B4D8?style=for-the-badge&logo=huggingface&logoColor=white)

**LLM Deployment & Serving**  
![Ollama](https://img.shields.io/badge/Ollama-000000?style=for-the-badge&logo=ollama&logoColor=white)
![vLLM](https://img.shields.io/badge/vLLM-412991?style=for-the-badge&logo=python&logoColor=white)
...
🎓 **B.Sc. Artificial Intelligence** — PMAS Arid Agriculture University, Rawalpindi *(2025)*

📜 Generative AI Essentials — *Microsoft & LinkedIn*  
📜 Building AI Voice Agents for Production — *DeepLearning.AI*  
📜 Workshop on Deep Learning & ML — *Barani Institute of Information Technology*
